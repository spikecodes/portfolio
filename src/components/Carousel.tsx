...
const carouselContent: CarouselItem[] = [
  {
    ...
    tagline:
      "UC Berkeley AI Hackathon, <span class='font-normal'>June 2024</span>",
    description:
      "Presented our project <a href='https://devpost.com/software/dispatch-ai' target='_blank' rel='noopener noreferrer' class='inline-flex items-center hover:underline text-primary group'>DispatchAI</a> to an audience of 1000. Our team was awarded 1st Place Grand Prize and >$50,000 in investments and grants.",
  ...
  },
  {
    ...
    tagline:
      "UCI AI Innovation Challenge, <span class='font-normal'>January 2024</span>",
    description:
  ...
  },
  {
    ...
    tagline:
      "LAHacks Google Company Challenge, <span class='font-normal'>April 2024</span>",
    description:
      "Secured 1st place (out of 142 teams) and $3000 with our project <a href='https://devpost.com/software/adapted' target='_blank' rel='noopener noreferrer' class='inline-flex items-center hover:underline text-primary group'>AdaptEd</a>, an adaptive, interactive, and personalized AI-powered lecture system.",
    hoverImage: adapted,
  ...
  },
  {
    ...
    tagline:
      "UCI Stella Zhang New Venture Competition, <span class='font-normal'>May 2024</span>",
    description:
      "Won 1st place overall ($20,000) and 1st in Business Products and Services Track ($10,000) with our project <a href='#' class='inline-flex items-center hover:underline text-primary group'>Sentinel</a>, the first driver-conscious AI dashcam to detect distraction and fatigue.",
    hoverImage: sentinel,
    projectUrl: "#",
...
const Carousel: React.FC<CarouselProps> = ({ onImageHover }) => {
  ...
  return (
    <>
      <h4 className="text-center uppercase tracking-widest text-gray-500 mb-4 opacity-70">
        Hackathons
      </h4>
      <motion.div
      ...
      >
        <AnimatePresence mode="wait">
          <motion.img
            ...
            onMouseEnter={() =>
              onImageHover(true, " " + carouselContent[currentSlide].alt)
            }
        ...
        >
          <h3
            ...
            dangerouslySetInnerHTML={{
              __html: carouselContent[currentSlide].tagline,
            }}
          ></h3>
          <p className="text-lg">
                  ...
                  {index < array.length - 1 && (
                    ...
                    >
                      <span className="group-hover:underline">
                        {carouselContent[currentSlide].projectName}
                      </span>
                    </a>
                  )}
                </React.Fragment>
      ...
      {!isMobile &&
        isHoveringLink &&
        carouselContent[currentSlide].hoverImage && (
          <motion.div
